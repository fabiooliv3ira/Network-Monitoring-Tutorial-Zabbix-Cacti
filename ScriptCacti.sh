...
sed -i 's/;date.timezone =/date.timezone = Europe\/Lisbon/g' /etc/php/8.2/apache2/php.ini
...
sed -i 's/;date.timezone =/date.timezone = Europe\/Lisbon/g' /etc/php/8.2/cli/php.ini
